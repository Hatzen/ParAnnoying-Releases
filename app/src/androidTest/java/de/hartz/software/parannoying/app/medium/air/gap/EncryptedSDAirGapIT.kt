...
class EncryptedSDAirGapIT: AbstractAirGapIntegrationTest() {

    lateinit var key: String

    @Test
    fun testSD() {
        testChannelWithUseCase(Channels.SD_CARD, R.id.sendEncryptedDataButton, R.id.receiveEncryptedDataButton)
    }
    ...
    override fun receive() {
        ...
        Espresso.onView(ViewMatchers.withId(R.id.fab_action_send)).perform(ViewActions.click())
        Thread.sleep(2500L) // Wait for finish receive.
    }
