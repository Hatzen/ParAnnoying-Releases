package de.hartz.software.parannoying.fake.entry;
...
// TODO: Wont work with Android 10
// https://stackoverflow.com/questions/29517277/how-can-i-configure-launcher-activity-programmatically-in-android
// https://stackoverflow.com/a/22754642/8524651
public class FakeEntryActivity extends AppCompatActivity {


    private void evalualteResult(double result) {
        if (result == 42) {
            startActivity(new Intent(this, StartupRedirectActivity.class));
        }
    }
